...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '../htdocs/static/hello.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_../htdocs/static/hello.data');

      };
      Module['addRunDependency']('datafile_../htdocs/static/hello.data');
   ...
   loadPackage({"files": [{"audio": 0, "start": 0, "end": 10, "filename": "/data.txt"}], "remote_package_size": 10, "package_uuid": "8b28eab4-2caa-487e-8ce6-d962f16adfba"});
...
var ASM_CONSTS = {
  2333: function() {console.log("EM_ASM: init functions: write data1.txt"); FS.writeFile("data1.txt", "a=1\nb=2\n"); FS.writeFile("data1.txt", new Uint8Array([99, 61, 51]) , { flags: "a" });},  
 2521: function() {var drawing = Module._get_drawing(); console.log("stop drawing cube:", drawing);},  
 3022: function() {var drawing = Module._get_drawing(); console.log("drawing cube:", drawing);},  
 70140: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 71619: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 72608: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 72701: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 73926: function() {return screen.width;},  
 73953: function() {return screen.height;},  
 73981: function() {return window.innerWidth;},  
 74013: function() {return window.innerHeight;},  
 74091: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 74225: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 74391: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 74617: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 75170: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
 75240: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.silenceTimer = setTimeout(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); }},  
 76892: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vi', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']);},  
 77302: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.capture.currentCaptureBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.capture.currentCaptureBuffer.getChannelData(c); if (channelData.length != $1) { throw 'Web Audio capture buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } if (numChannels == 1) { for (var j = 0; j < $1; ++j) { setValue($0 + (j * 4), channelData[j], 'float'); } } else { for (var j = 0; j < $1; ++j) { setValue($0 + (((j * numChannels) + c) * 4), channelData[j], 'float'); } } }},  
 77907: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.audio.currentOutputBuffer['numberOfChannels']; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.audio.currentOutputBuffer['getChannelData'](c); if (channelData.length != $1) { throw 'Web Audio output buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } for (var j = 0; j < $1; ++j) { channelData[j] = HEAPF32[$0 + ((j*numChannels + c) << 2) >> 2]; } }},  
 78387: function($0) {var SDL2 = Module['SDL2']; if ($0) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); } if (SDL2.capture.stream !== undefined) { var tracks = SDL2.capture.stream.getAudioTracks(); for (var i = 0; i < tracks.length; i++) { SDL2.capture.stream.removeTrack(tracks[i]); } SDL2.capture.stream = undefined; } if (SDL2.capture.scriptProcessorNode !== undefined) { SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) {}; SDL2.capture.scriptProcessorNode.disconnect(); SDL2.capture.scriptProcessorNode = undefined; } if (SDL2.capture.mediaStreamNode !== undefined) { SDL2.capture.mediaStreamNode.disconnect(); SDL2.capture.mediaStreamNode = undefined; } if (SDL2.capture.silenceBuffer !== undefined) { SDL2.capture.silenceBuffer = undefined } SDL2.capture = undefined; } else { if (SDL2.audio.scriptProcessorNode != undefined) { SDL2.audio.scriptProcessorNode.disconnect(); SDL2.audio.scriptProcessorNode = undefined; } SDL2.audio = undefined; } if ((SDL2.audioContext !== undefined) && (SDL2.audio === undefined) && (SDL2.capture === undefined)) { SDL2.audioContext.close(); SDL2.audioContext = undefined; }}
};
function init_globals(){ console.log("init globals internal"); var imported = document.createElement('script'); var xmlhttp_system = new XMLHttpRequest(); function xmlhttp_respone() { if (this.readyState == 4 && this.status == 200) { var obj_response = this.responseText; imported.type = "application/javascript"; imported.text = obj_response; document.getElementsByTagName('body')[0].appendChild(imported); window.testglobal = "XHR ready state1"; } }; xmlhttp_system.onreadystatechange = xmlhttp_respone; xmlhttp_system.overrideMimeType("application/javascript"); xmlhttp_system.open("GET", "globals.js", true); xmlhttp_system.send(); }
function set_element_fps_angle(fps,angle){ var element_fps = document.getElementById('fps'); var element_angle = document.getElementById('angle'); var result_fps = Math.round((fps * 100) / 100); element_fps.innerHTML = result_fps; element_angle.innerHTML = Math.round(angle); }
function tim2(){ if (globals.initialized) { var s1 = 'Sum internal: ' + Module._Sum(8, 20); console.log(s1); console_printf(s1); } else { console_printf('Tim2 nel'); } console_printf('Tim2 global: ' + testglobal); console.log("Tim2 global:", testglobal); }
function take_args(x,y){ setTimeout(tim2, 1000); console_printf('Take args received: [' + x + ', ' + y + ']'); console_printf('Call Sum from Take args: ' + Module._Sum(1, 4)); }
  ...
  Module["_emscripten_glAlphaFunc"] = _emscripten_glAlphaFunc;
  ...
  Module["GLEmulation"] = GLEmulation;
  ...
  Module["GLImmediate"] = GLImmediate;
  ...
  Module["GLImmediateSetup"] = GLImmediateSetup;
  ...
  Module["_emscripten_glBindProgram"] = _emscripten_glBindProgram;
  ...
  Module["_glEnableClientState"] = _glEnableClientState;
  ...
  Module["_emulGlBindVertexArray"] = _emulGlBindVertexArray;
  ...
  Module["_emscripten_glClientActiveTexture"] = _emscripten_glClientActiveTexture;
  ...
  Module["_emscripten_glColorPointer"] = _emscripten_glColorPointer;
  ...
  Module["_emscripten_glDeleteObject"] = _emscripten_glDeleteObject;
  ...
  Module["_emulGlDeleteVertexArrays"] = _emulGlDeleteVertexArrays;
  ...
  Module["_emscripten_glDisableClientState"] = _emscripten_glDisableClientState;
  ...
  Module["_emscripten_glDrawBuffer"] = _emscripten_glDrawBuffer;
  ...
  Module["_emscripten_glEnableClientState"] = _emscripten_glEnableClientState;
  ...
  Module["_emscripten_glEnd"] = _emscripten_glEnd;
  ...
  Module["_emscripten_glFrustum"] = _emscripten_glFrustum;
  ...
  Module["_emulGlGenVertexArrays"] = _emulGlGenVertexArrays;
  ...
  Module["_emscripten_glGetInfoLog"] = _emscripten_glGetInfoLog;
  ...
  Module["_emscripten_glGetObjectParameteriv"] = _emscripten_glGetObjectParameteriv;
  ...
  Module["_emscripten_glGetPointerv"] = _emscripten_glGetPointerv;
  ...
  Module["_emscripten_glGetTexEnvfv"] = _emscripten_glGetTexEnvfv;

  function _emscripten_glGetTexEnviv(target, pname, param) { throw 'GL emulation not initialized!'; }
  Module["_emscripten_glGetTexEnviv"] = _emscripten_glGetTexEnviv;

  function _emscripten_glGetTexLevelParameteriv() { throw 'glGetTexLevelParameteriv: TODO' }
  Module["_emscripten_glGetTexLevelParameteriv"] = _emscripten_glGetTexLevelParameteriv;
  ...
  Module["_emulGlIsVertexArray"] = _emulGlIsVertexArray;
  ...
  Module["_emscripten_glLightModelfv"] = _emscripten_glLightModelfv;

  function _emscripten_glLightfv() { throw 'glLightfv: TODO' }
  Module["_emscripten_glLightfv"] = _emscripten_glLightfv;
  ...
  Module["_emscripten_glLoadMatrixd"] = _emscripten_glLoadMatrixd;
  ...
  Module["_emscripten_glLoadMatrixf"] = _emscripten_glLoadMatrixf;
  ...
  Module["_emscripten_glLoadTransposeMatrixd"] = _emscripten_glLoadTransposeMatrixd;
  ...
  Module["_emscripten_glLoadTransposeMatrixf"] = _emscripten_glLoadTransposeMatrixf;

  function _emscripten_glMaterialfv() { throw 'glMaterialfv: TODO' }
  Module["_emscripten_glMaterialfv"] = _emscripten_glMaterialfv;
  ...
  Module["_emscripten_glMultMatrixd"] = _emscripten_glMultMatrixd;
  ...
  Module["_emscripten_glMultMatrixf"] = _emscripten_glMultMatrixf;
  ...
  Module["_emscripten_glMultTransposeMatrixd"] = _emscripten_glMultTransposeMatrixd;
  ...
  Module["_emscripten_glMultTransposeMatrixf"] = _emscripten_glMultTransposeMatrixf;

  function _emscripten_glNormal3f(){}
  Module["_emscripten_glNormal3f"] = _emscripten_glNormal3f;
  ...
  Module["_emscripten_glNormalPointer"] = _emscripten_glNormalPointer;
  ...
  Module["_emscripten_glOrtho"] = _emscripten_glOrtho;
  ...
  Module["_emscripten_glPolygonMode"] = _emscripten_glPolygonMode;
  ...
  Module["_emscripten_glPopMatrix"] = _emscripten_glPopMatrix;
  ...
  Module["_emscripten_glPushMatrix"] = _emscripten_glPushMatrix;
  ...
  Module["_emscripten_glRotated"] = _emscripten_glRotated;
  ...
  Module["_emscripten_glRotatef"] = _emscripten_glRotatef;
  ...
  Module["_emscripten_glScaled"] = _emscripten_glScaled;
  ...
  Module["_emscripten_glScalef"] = _emscripten_glScalef;
  ...
  Module["_emscripten_glShadeModel"] = _emscripten_glShadeModel;
  ...
  Module["_emscripten_glTexCoord2f"] = _emscripten_glTexCoord2f;
  ...
  Module["_emscripten_glTexCoord2i"] = _emscripten_glTexCoord2i;
  function _emscripten_glTexCoord2fv(v) {
      _emscripten_glTexCoord2i(HEAPF32[((v)>>2)], HEAPF32[(((v)+(4))>>2)]);
    }
  Module["_emscripten_glTexCoord2fv"] = _emscripten_glTexCoord2fv;


  function _emscripten_glTexCoord3f() { throw 'glTexCoord3f: TODO' }
  Module["_emscripten_glTexCoord3f"] = _emscripten_glTexCoord3f;

  function _emscripten_glTexCoord4f() { throw 'glTexCoord4f: TODO' }
  Module["_emscripten_glTexCoord4f"] = _emscripten_glTexCoord4f;
  ...
  Module["_emscripten_glTexCoordPointer"] = _emscripten_glTexCoordPointer;

  function _emscripten_glTexGenfv() { throw 'glTexGenfv: TODO' }
  Module["_emscripten_glTexGenfv"] = _emscripten_glTexGenfv;

  function _emscripten_glTexGeni() { throw 'glTexGeni: TODO' }
  Module["_emscripten_glTexGeni"] = _emscripten_glTexGeni;

  function _emscripten_glTexImage1D() { throw 'glTexImage1D: TODO' }
  Module["_emscripten_glTexImage1D"] = _emscripten_glTexImage1D;
  ...
  Module["_emscripten_glTranslated"] = _emscripten_glTranslated;
  ...
  Module["_emscripten_glTranslatef"] = _emscripten_glTranslatef;
  ...
  Module["_emscripten_glVertex2f"] = _emscripten_glVertex2f;

  function _emscripten_glVertex2fv(p) {
      _emscripten_glVertex2f(HEAPF32[((p)>>2)], HEAPF32[(((p)+(4))>>2)]);
    }
  Module["_emscripten_glVertex2fv"] = _emscripten_glVertex2fv;
  ...
  Module["_emscripten_glVertex2i"] = _emscripten_glVertex2i;
  ...
  Module["_emscripten_glVertex3f"] = _emscripten_glVertex3f;

  function _emscripten_glVertex3fv(p) {
      _emscripten_glVertex3f(HEAPF32[((p)>>2)], HEAPF32[(((p)+(4))>>2)], HEAPF32[(((p)+(8))>>2)]);
    }
  Module["_emscripten_glVertex3fv"] = _emscripten_glVertex3fv;
  ...
  Module["_emscripten_glVertex3i"] = _emscripten_glVertex3i;
  ...
  Module["_emscripten_glVertex4i"] = _emscripten_glVertex4i;
  ...
  Module["_glColor3fv"] = _glColor3fv;
  ...
  Module["_glTranslatef"] = _glTranslatef;
  ...
  Module["_glVertex3fv"] = _glVertex3fv;
...
var asmLibraryArg = {
  ...
  "set_element_fps_angle": set_element_fps_angle,
...
/** @type {function(...*):?} */
var _Sum_ccall = Module["_Sum_ccall"] = createExportWrapper("Sum_ccall");

/** @type {function(...*):?} */
var _console_printf = Module["_console_printf"] = createExportWrapper("console_printf");

/** @type {function(...*):?} */
var _set_websock_response = Module["_set_websock_response"] = createExportWrapper("set_websock_response");
...
/** @type {function(...*):?} */
var _set_stream_response = Module["_set_stream_response"] = createExportWrapper("set_stream_response");

/** @type {function(...*):?} */
var _set_cube_angle = Module["_set_cube_angle"] = createExportWrapper("set_cube_angle");

/** @type {function(...*):?} */
var _stop_drawing = Module["_stop_drawing"] = createExportWrapper("stop_drawing");

/** @type {function(...*):?} */
var _get_drawing = Module["_get_drawing"] = createExportWrapper("get_drawing");

/** @type {function(...*):?} */
var _draw_cube = Module["_draw_cube"] = createExportWrapper("draw_cube");
